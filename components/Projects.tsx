      ...
      <div className="grid gap-5 sm:grid-cols-2">
        {projects.map((project, i) => (
          <motion.a
            ...
            className="block"
          >
            <TiltCard className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-line bg-surface p-6 transition-colors hover:border-accent/60">
